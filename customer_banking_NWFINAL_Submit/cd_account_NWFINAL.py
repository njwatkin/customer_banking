...
def create_cd_account(balance, interest_rate, months):
    ...
    cd_updated_balance = balance + cd_interest_earned
...
result1, result2 = create_cd_account(22, 0.20, 82)

#Print:
print("Your updated cd account balance is $", result1, "and your interest earned is $", result2) 
